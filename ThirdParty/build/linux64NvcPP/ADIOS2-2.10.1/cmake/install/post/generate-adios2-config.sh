...
SOURCE_DIR="/home/sibo/TesboCFD/ThirdParty-v2412/sources/adios/ADIOS2-2.10.1/cmake/install/post/adios2-config-dummy"
BUILD_DIR=$(mktemp -d)
pushd ${BUILD_DIR}

if [ 1 -eq 1 ]
then
  export CC="/home/sibo/Music/nvidia-hpc-sdk/Linux_x86_64/24.11/comm_libs/mpi/bin/mpicc"
fi
if [ 1 -eq 1 ]
then
  export CXX="/home/sibo/Music/nvidia-hpc-sdk/Linux_x86_64/24.11/comm_libs/mpi/bin/mpicxx"
fi
if [ 0 -eq 1 ]
then
  export FC=""
...
if [ -z "$adios2_DIR" ]
then
  export adios2_DIR="${PREFIX}/lib64/cmake/adios2"
fi

# Sometimes package managers build in root jails
if [ ! -d "${adios2_DIR}" ]
then
  adios2_DIR="/home/sibo/TesboCFD/ThirdParty-v2412/build/linux64NvcPP/ADIOS2-2.10.1/${PREFIX}/lib64/cmake/adios2"
fi
...
cat \
  "/home/sibo/TesboCFD/ThirdParty-v2412/build/linux64NvcPP/ADIOS2-2.10.1/cmake/install/post/adios2-config.pre.sh" \
  adios2.flags \
  "/home/sibo/TesboCFD/ThirdParty-v2412/build/linux64NvcPP/ADIOS2-2.10.1/cmake/install/post/adios2-config.post.sh" > "${BINDIR}/adios2-config"
